...
module.exports = (app, config) =>
  app.post('/dblistwebhook', async (req, res) => {
    ...
    if (
      ...
      await sendNotification(body.id, 'vote', 'Thank you for voting!', 'You just got your **`1 banknote, 1 horseshoe, and 5k coins`** for voting on discordbotlist.com! (Extra 4k coins for supporting this growing site)');
